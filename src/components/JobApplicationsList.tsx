...
import { FileText, Calendar, Mail, Phone, Building2, User, CheckCircle, XCircle, Clock } from 'lucide-react';
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <div className="flex justify-between">
                  <button
                    onClick={() => window.open(application.resume)}
                    className="text-blue-600 hover:text-blue-700 font-medium text-sm"
                  >
                    View Resume
                  </button>
                  <button
                    onClick={() => window.open(application.coverLetter)}
                    className="text-blue-600 hover:text-blue-700 font-medium text-sm"
                  >
                    View Cover Letter
                  </button>
